...
async function processTick(tick) {
    ...
    // ⚠️ Mantendo tua lógica de Martingale original
    ...
    // Evita stake acima do saldo disponível
...
export async function startBot() {
    ...
    // 🔥 Fecha e limpa qualquer conexão antiga antes de iniciar novamente
    ...
    shouldStop = false;
    reconnectMs = cfg.reconnect_base_ms; // reseta reconexão
    ...
    // Força recepção de ticks contínua (mantém o bot ativo)
    setInterval(() => {
